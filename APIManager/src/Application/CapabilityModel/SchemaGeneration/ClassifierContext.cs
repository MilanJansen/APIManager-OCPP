...
namespace Plugin.Application.CapabilityModel.SchemaGeneration
{
    ...
    internal class ClassifierContext
    {
        ...
        /// <param name="typeName">The primitive type name associated with this classifier.</param>
        /// <param name="scope">Classifier schema- and documentation scope.</param>
        internal ClassifierContext(ContentTypeCode cType, string name, string typeName, Tuple<ScopeCode, DocScopeCode> scope)
        {
        ...
        /// <summary>
        /// Get- or set the primitive type name of the classifier.
        /// </summary>
