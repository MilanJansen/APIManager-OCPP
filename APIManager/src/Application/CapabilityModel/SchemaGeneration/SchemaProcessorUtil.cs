            ...
            if (typeName != string.Empty)
            {
                ...
                switch (typeDescriptor.Item1)
                {
                    case MEDataType.MetaDataType.SimpleType:
                        {
                            ...
                            classifierCtx = new ClassifierContext(ClassifierContext.ContentTypeCode.Simple, classifier.Name, typeDescriptor.Item2, scope);
                        }
                        break;
                    ...
                    case MEDataType.MetaDataType.ComplexType:
                        {
                            ...
                            classifierCtx = new ClassifierContext(ClassifierContext.ContentTypeCode.Complex, classifier.Name, typeDescriptor.Item2, scope);
                        }
                        break;
                    ...
                    case MEDataType.MetaDataType.Enumeration:
                        {
                            ...
                            classifierCtx = new ClassifierContext(ClassifierContext.ContentTypeCode.Enum, classifier.Name, typeDescriptor.Item2, scope);
                    ...
                    default:
                        ...
                        classifierCtx = new ClassifierContext(ClassifierContext.ContentTypeCode.Unknown, classifier.Name, typeDescriptor.Item2, scope);
                        break;
                }
