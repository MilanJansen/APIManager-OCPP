...
namespace Plugin.Application.CapabilityModel.ASCIIDoc
{
    ...
    internal sealed class ClassifierDocNode
    {
        ...
        private string _formattedType;      // ASCIIDoc formatted primitive type descriptor.
        private bool _isEnumeration;        // Set to 'true' if this is an enumeration.
        ...
        /// <summary>
        /// Returns 'true' if the classifier is an enumeration, false for primitive types.
        /// </summary>
        internal bool IsEnumeration { get { return this._isEnumeration; } }
        ...
        /// <summary>
        /// Returns the ASCIIDoc formatted type descriptor.
        /// </summary>
        internal string FormattedType { get { return this._formattedType; } }
        ...
        internal ClassifierDocNode(string contextID, MEDataType classifier, List<Facet> facetList, List<SupplementaryAttribute> attribList, string primName, string qualifiedName, int level)
        {
            ...
            if (classifier.Type == ModelElementType.Enumeration)
            {
                ...
                this._formattedType = string.Empty;
            ...
            else
            {
                ...
                this._formattedType = context.GetConfigProperty(_ASCIIDocTypeRow);
                ...
                if (facetList != null && facetList.Count > 0)
                {
                    ...
                    {
                        this._formattedType = this._formattedType.Replace(FacetToken, facetInfo.Item1);
                        this._formattedType = this._formattedType.Replace(TypeNotesToken, facetInfo.Item2);
                    }
                    else
                    {
