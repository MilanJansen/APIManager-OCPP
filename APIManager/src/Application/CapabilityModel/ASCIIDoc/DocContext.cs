...
namespace Plugin.Application.CapabilityModel.ASCIIDoc
{
    ...
    internal abstract class DocContext: IComparable<DocContext>
    {
        ...
        /// <param name="ctx">Classifier metadata.</param>
        ...
        {
            if (this._currentNode != null) this._currentNode.AddAttribute(name, type, ctx, classifierContextID, cardinality, notes);
        }
        ...
        /// <summary>
        /// Retrieves the ASCIIDoc formatted description of the classifier with given name.
        /// </summary>
        /// <param name="classifierName">Classifier for which we retrieve the information.</param>
        /// <returns>ASCIIDoc formatted text or empty string if classifier not found.</returns>
        public string GetFormattedClassifier(string classifierName)
        {
            return (this._classifiers.ContainsKey(classifierName)) ? this._classifiers[classifierName].FormattedType : string.Empty;
        }
